...
int writeChannelID = 2341773 ; // Channel ID
char writeAPIKey[] = "QRUCBR7BV8ZNLCDX"; // Write API Key
...
void loop() {
  ...
  p25=p25*1.1623788719513894+8.798736057025366;

  p10=p10*2.786716898825535+1.20368527138779114;
